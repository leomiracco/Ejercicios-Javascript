export const data = {
  ...
  inputId: {},
  validationErrorMessage: "Solo se admiten números Naturales.",
  outOfRangeErrorMessage: "El nro. de Id, debe estar comprendido entre",
  searchResult: "El resultado de la búsqueda aparecerá aquí...",
  bothFields: "La búsqueda no puede realizarse por ambos campos al mismo tiempo...",
  pizzaNameNotFound: "Nombre de Pizza no encontrada. Recuerde el uso de acentos.",
  bothInputsCannotBeLeftEmpty: "Ambos casilleros NO pueden quedar vacíos.",
  pizzas: [
